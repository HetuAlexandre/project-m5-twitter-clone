...
const Profile = () => {
  ...
  const [userHandle, setHandle] = useState(
    useHistory().location.pathname.replace("/", "")
  );
            ...
            <InfoBox>
              ...
              <ALine>
                {user.location ? (
                  <ItemBox>
                    <GrLocation />
                    <ItemText>{user.location}</ItemText>
                  </ItemBox>
                ) : null}
                <ItemBox>
                  <FiCalendar />
              ...
              <ALine>
                <ItemBox>
                  <Number>{user.numFollowing}</Number>
                  <ItemText>Following</ItemText>
                </ItemBox>
                <ItemBox>
                  <Number>{user.numFollowers}</Number>
